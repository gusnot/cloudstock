...
export class SkuService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/skus';

    constructor(private http: Http) { }

    create(sku: Sku): Observable<Sku> {
     ...
     */
    private convertItemFromServer(json: any): Sku {
        const entity: Sku = Object.assign(new Sku(), json);
        return entity;
    }
