...
export class SellService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/sells';
    ...
    find(id: number): Observable<Sell> {
     ...
     */
    private convertItemFromServer(json: any): Sell {
        const entity: Sell = Object.assign(new Sell(), json);
        return entity;
    }
