...
export class TransferService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/transfers';
     ...
     */
    private convertItemFromServer(json: any): Transfer {
        const entity: Transfer = Object.assign(new Transfer(), json);
        return entity;
    }
