...
export class BillItemService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/bill-items';

    constructor(private http: Http) { }

    create(billItem: BillItem): Observable<BillItem> {
    ...
    update(billItem: BillItem): Observable<BillItem> {
        const copy = this.convert(billItem);
    ...
    find(id: number): Observable<BillItem> {
     ...
     */
    private convertItemFromServer(json: any): BillItem {
        const entity: BillItem = Object.assign(new BillItem(), json);
        return entity;
    }
